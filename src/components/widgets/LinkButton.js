...
export default class LinkButton extends React.Component {
  ...
  render () {
    console.debug ('Render LinkButton with widgetdata:');
    console.log (this.props.widgetData);
    let linkText = (
      <span className={'valueSwitcherValue'}>
        {this.props.widgetData.linkText}
      </span>
    );
    ...
    if (
      this.props.widgetData.extLink !== true &&
      !this.props.widgetData.pageLinks === undefined &&
      !this.props.widgetData.pageLinks[this.props.widgetData.targetpage]
    ) {
